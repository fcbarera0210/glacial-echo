...
class GameSimulator {
    ...
    simulateGame(gameNumber) {
        ...
        const simulateRoll = (difficulty, mental, itemModifier = 0) => {
            stats.totalRolls++;
            const mentalModifier = this.getMentalModifier(mental);
            const roll = (0, utils_1.rand)(1, 6) + mentalModifier + itemModifier;
        ...
        const useConsumableItems = () => {
            ...
            if (day < 6 && !game.state.isAntennaReinforced) {
                ...
                if (antennaKit >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, antennaKit, game.state, game.state.inventoryMaxSlots);
                    if (result) {
            ...
            if (game.state.mental < 60 && (!game.state.adrenalineBoostDays || game.state.adrenalineBoostDays === 0)) {
                ...
                if (adrenaline >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, adrenaline, game.state, game.state.inventoryMaxSlots);
                    if (result) {
                        game.state = result.newState;
            ...
            if (game.state.life < 70) {
                ...
                if (medkit >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, medkit, game.state, game.state.inventoryMaxSlots);
                    if (result) {
                        game.state = result.newState;
            ...
            if (game.state.mental < 50) {
                ...
                if (coffee >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, coffee, game.state, game.state.inventoryMaxSlots);
                    if (result) {
                        game.state = result.newState;
            ...
            if (game.state.life < 80) {
                ...
                if (bandages >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, bandages, game.state, game.state.inventoryMaxSlots);
                    if (result) {
                        game.state = result.newState;
            ...
            if (game.state.life < 80) {
                ...
                if (ration >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, ration, game.state, game.state.inventoryMaxSlots);
                    if (result) {
                        game.state = result.newState;
            ...
            if (game.state.mental < 70 || game.state.life < 90) {
                ...
                if (water >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, water, game.state, game.state.inventoryMaxSlots);
                    if (result) {
                        game.state = result.newState;
            ...
            if (game.state.mental < 80) {
                ...
                if (chocolate >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, chocolate, game.state, game.state.inventoryMaxSlots);
                    if (result) {
                        game.state = result.newState;
            ...
            if (game.state.mental < 40 && game.state.life > 20) {
                ...
                if (whisky >= 0) {
                    const result = (0, inventory_1.useItem)(inventory, whisky, game.state, game.state.inventoryMaxSlots);
                    if (result) {
                        game.state = result.newState;
        ...
        try {
            while (!game.state.gameOver && stats.daysSurvived < maxDays) {
                ...
                const cardsThisDay = game.state.cardsPending || (0, utils_1.rand)(1, 6);
