...
exports.isInventoryFull = exports.getInventoryUsedSlots = exports.getInventoryItemCount = exports.getItemFromInventory = exports.hasItem = exports.useItem = exports.reduceItemQuantity = exports.removeItem = exports.addItem = exports.canAddItem = void 0;
/**
 * Verifica si se puede agregar un objeto al inventario
 */
function canAddItem(inventory, item, maxSlots) {
 ...
 */
function addItem(inventory, item, maxSlots) {
 ...
 */
function removeItem(inventory, index) {
 ...
 */
function reduceItemQuantity(inventory, index) {
    if (index < 0 || index >= inventory.length) {
        return inventory;
    }
 ...
 */
function useItem(inventory, index, state, maxSlots) {
    if (index < 0 || index >= inventory.length) {
        return null;
    }
    const item = inventory[index];
 ...
 */
function applySpecialEffects(state, item) {
...
exports.getItemFromInventory = getItemFromInventory;
/**
 * Obtiene el número total de objetos en el inventario (contando apilados)
 */
function getInventoryItemCount(inventory) {
    return inventory.reduce((total, item) => {
        return total + (item.quantity || 1);
    }, 0);
}
exports.getInventoryItemCount = getInventoryItemCount;
/**
...
exports.getInventoryUsedSlots = getInventoryUsedSlots;
/**
 * Verifica si el inventario está lleno
 */
function isInventoryFull(inventory, maxSlots) {
