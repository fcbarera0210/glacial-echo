...
exports.generateOperationEvent = exports.generateAnomalyEvent = exports.generateInfrastructureNegativeEvent = void 0;
const utils_1 = require("./utils");
/**
 * Genera un evento de Infraestructura negativo (40% de Diamonds)
 */
function generateInfrastructureNegativeEvent() {
    const events = [
        {
            id: 'pipe_burst',
    ...
    return events[(0, utils_1.rand)(0, events.length - 1)];
}
exports.generateInfrastructureNegativeEvent = generateInfrastructureNegativeEvent;
/**
 ...
 */
function generateAnomalyEvent(mental) {
    // Reducir daño base en 25% (Opción 4)
    const baseDamageRaw = mental < 20 ? (0, utils_1.rand)(15, 25) : mental < 40 ? (0, utils_1.rand)(10, 18) : (0, utils_1.rand)(8, 15);
    ...
    return eventPool[(0, utils_1.rand)(0, eventPool.length - 1)];
}
exports.generateAnomalyEvent = generateAnomalyEvent;
/**
 * Genera un evento de Operación (Work/Spades)
 */
function generateOperationEvent() {
    const operations = [
        {
            id: 'corrupted_file',
    ...
    return operations[(0, utils_1.rand)(0, operations.length - 1)];
}
exports.generateOperationEvent = generateOperationEvent;
