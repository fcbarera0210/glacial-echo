...
exports.getItemsByType = exports.getItemByCard = exports.getItemById = exports.SPECIAL_ITEMS_MAPPING = exports.DIAMONDS_SPECIAL_MAPPING = exports.DIAMONDS_MAPPING = exports.HEARTS_MAPPING = exports.BASE_ITEMS = exports.SUPPLIES_ITEMS = void 0;
// ============================================================================
// SUMINISTROS (Hearts/Introspection) - Tipo: 'supplies'
// ============================================================================
exports.SUPPLIES_ITEMS = {
    // Comunes (9)
    'ration': {
        id: 'supply_ration',
...
function getItemById(id) {
    ...
    for (const item of Object.values(exports.SUPPLIES_ITEMS)) {
        if (item.id === id)
            return item;
    }
    // Buscar en Infraestructura
    for (const item of Object.values(exports.BASE_ITEMS)) {
        if (item.id === id)
            return item;
    }
    return null;
...
function getItemByCard(suit, rank) {
    if (suit === '♥' || suit === 'HEARTS') {
        const key = exports.HEARTS_MAPPING[rank];
        if (key && exports.SUPPLIES_ITEMS[key]) {
            return { ...exports.SUPPLIES_ITEMS[key] };
        }
    }
    else if (suit === '♦' || suit === 'DIAMONDS') {
        // 60% objeto, 40% evento (se maneja en la lógica del juego)
        const key = exports.DIAMONDS_MAPPING[rank];
        if (key && exports.BASE_ITEMS[key]) {
            return { ...exports.BASE_ITEMS[key] };
        }
    }
    return null;
}
exports.getItemByCard = getItemByCard;
// Función para obtener todos los objetos de un tipo
function getItemsByType(type) {
    if (type === 'supplies') {
        return Object.values(exports.SUPPLIES_ITEMS);
    }
    else {
        return Object.values(exports.BASE_ITEMS);
    }
}
